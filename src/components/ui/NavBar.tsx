...
export default function NavBar(){
    ...
    function sideMenue(){
        ...
        return (
            <>
                <div id="mynavbar" className="navbar flex items-center justify-between text-white p-2 relative bg-[#272727] drop-shadow-xl sm:px-6 lg:px-8 w-full">
                <div>
                    <Image
                        src="/logo.png"
                        alt="Logo"
                ...
                <ul className="hidden xl:flex gap-4 text-white">
                    <li><Link href="/">Home</Link></li>
                    <li><Link href="/services">Services</Link></li>
                    <li><Link href="/about">Service provice</Link></li>
                    <li><Link href="/about">Contatct Us</Link></li>
                </ul>
                <div id="controls" className="space-x-4 hidden xl:flex text-white ">
                    <button className="mx-2 rounded-2xl underline w-fit p-2">register</button>
                    <button className="mx-2 rounded-2xl bg-[#272727] w-[6em] p-2 
                    hover:bg-[hsla(0,0%,67%,1)]"><a href="">login</a></button>
                    <button className="mx-2 rounded-2xl bg-[#272727] w-[15em] p-2
